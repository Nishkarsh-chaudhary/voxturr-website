...
const AccordianCardTwo: FC<IResultCardProps> = ({
  description,
  numberOfResult,
  title,
  backgrundColor,
  ...
  const handleToggleCard = () => {
    ...
    controls.start(isCardOpen ? { height: 0 } : { height: "auto" });
  };
  ...
  return (
    ...
    >
      <div className="flex items-center justify-center px-4" onClick={handleToggleCard}>
        <h3
...
export default AccordianCardTwo;
